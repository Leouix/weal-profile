 ...
 * Description:       Creates a personal account page where logged-in users can manage their profile information, review their site activity, see comment reactions, and earn achievements based on community participation. Client-side caching for improved performance.
 * Version:           1.4.2
 * Author:            leouix
 ...
 */
define( 'WEAL_PROFILE_VERSION', '1.4.2' );
define( 'WEAL_PROFILE_DB_VERSION', '1.3.0' );
