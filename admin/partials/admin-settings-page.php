...
<div class="au-container">
	<form id="admin-user-account-form">
		...
		<h1><?php esc_html_e( 'Plugin settings page', 'weal-user-account' ); ?></h1>

		<div class="url-label-area">
			<label for="adu-form-input" class="sub-title"><?php esc_html_e( 'URL user page:', 'weal-user-account' ); ?></label>
		...
		<div  class="sub-title"><?php esc_html_e( 'Which fields should be shown in the user account?', 'weal-user-account' ); ?></div>
		...
		<div class="label-area">
			...
			<label for="adu-display_name"><?php esc_html_e( 'display_name', 'weal-user-account' ); ?></label><br>
		</div>
		...
		<div class="label-area">
			...
			<label for="adu-nickname"><?php esc_html_e( 'nickname', 'weal-user-account' ); ?></label><br>
		</div>
		...
		<div class="label-area">
			...
			<label for="adu-first_name"><?php esc_html_e( 'first_name', 'weal-user-account' ); ?></label><br>
		</div>
		...
		<div class="label-area">
			...
			<label for="adu-last_name"><?php esc_html_e( 'last_name', 'weal-user-account' ); ?></label><br>
		</div>
		...
		<div class="label-area">
			...
			<label for="adu-user_url"><?php esc_html_e( 'user_url', 'weal-user-account' ); ?></label><br>
		</div>
		...
		<div class="label-area">
			...
			<label for="adu-description"><?php esc_html_e( 'description', 'weal-user-account' ); ?></label><br>
		</div>

		<div class="button-area">
			<input id="save-create-button" type="submit" value="<?php esc_attr_e( 'Сохранить настройки', 'weal-user-account' ); ?>">
			<div id="success-notice"><?php esc_html_e( 'Success!', 'weal-user-account' ); ?></div>
		</div>
